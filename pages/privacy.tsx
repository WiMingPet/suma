    ...
    <>
      ...
      <div className="min-h-screen bg-gray-50 py-12 px-4">
        <div className="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-8 relative">
          ...
          <p className="text-center text-gray-500 mb-8">更新日期：2026年6月21日</p>
          ...
          <div className="space-y-6 text-gray-700">
            <section>
              ...
              <ul className="list-disc pl-6 mt-2 space-y-1">
                ...
                <li><strong>提示词/问题描述</strong>：您在使用文字生成、图片识别功能时输入的文本内容。</li>
                <li><strong>上传的图片</strong>：您在使用图片识别功能时上传的图片。</li>
                <li><strong>聊天对话内容</strong>：您在使用AI编程助手功能时输入的文字内容。</li>
              </ul>
            </section>
            ...
            <section>
              <h2 className="text-xl font-semibold mb-3">7. 儿童隐私</h2>
